...
public class ReproduccionCancionController implements Initializable {
    ...
    private void cambiarAImagenPlay() {
        try {
            Image img = new Image(getClass().getResourceAsStream("../Resources/img/boton-de-play.png"));
            imgPlayPause.setImage(img);
            imgPlayPause.setFitWidth(29.0);
            imgPlayPause.setFitHeight(26.0);
        } catch (Exception e) {
            imgPlayPause.setImage(new Image(getClass().getResourceAsStream("../Resources/img/play.png")));
        }
    }

    private void cambiarAImagenPause() {
        try {
            Image img = new Image(getClass().getResourceAsStream("../Resources/img/boton-de-pausa.png"));
            imgPlayPause.setImage(img);
            imgPlayPause.setFitWidth(40.0);
            imgPlayPause.setFitHeight(35.0);
        } catch (Exception e) {
            imgPlayPause.setImage(new Image(getClass().getResourceAsStream("../Resources/img/pause.png")));
        }
    }
