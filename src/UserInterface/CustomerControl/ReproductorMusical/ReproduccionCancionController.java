...
public class ReproduccionCancionController implements Initializable {
    ...
    private void cambiarAImagenPlay() {
        imgPlayPause.setImage(new Image(getClass().getResourceAsStream("/UserInterface/Resources/ReproductorMusical/img/boton-de-play.png")));
    }
    ...
    private void cambiarAImagenPause() {
        imgPlayPause.setImage(new Image(getClass().getResourceAsStream("/UserInterface/Resources/ReproductorMusical/img/boton-de-pausa.png")));
    }
    ...
    private void mostrarPortadaCancion(CancionDTO cancion) {
        try {
            ...
            if (cancion.getPortada() != null && cancion.getPortada().length > 0) {
                ...
                portada = new Image(getClass().getResourceAsStream("/UserInterface/Resources/ReproductorMusical/img/portada-generica.jpg"));
            }
            ...
            Image errorImage = new Image(getClass().getResourceAsStream("/UserInterface/Resources/ReproductorMusical/img/portada-generica.jpg"));
