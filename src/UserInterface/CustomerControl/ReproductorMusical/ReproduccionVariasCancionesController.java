...
public class ReproduccionVariasCancionesController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        InputStream stream = getClass().getResourceAsStream("/UserInterface/Resources/ReproductorMusical/img/portada-generica.jpg");
    ...
    private void cambiarIconoPlay(boolean aPlay) {
        imgPlayPause.setImage(new Image(getClass().getResourceAsStream("/UserInterface/Resources/ReproductorMusical/img/" + (aPlay ? "boton-de-play.png" : "boton-de-pausa.png"))));
    }
}
