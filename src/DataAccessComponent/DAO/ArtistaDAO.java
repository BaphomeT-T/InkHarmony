...
/**
 * Clase de acceso a datos (DAO) para la entidad Artista.
 * Proporciona operaciones CRUD (Crear, Leer, Actualizar, Eliminar) para gestionar
 * artistas en la base de datos SQLite, incluyendo la gestión de sus géneros musicales asociados.
 *
 * Esta clase extiende SQLiteDataHelper para heredar funcionalidades de conexión
 * a la base de datos e implementa la interfaz IDAO para garantizar el cumplimiento
 * del contrato de operaciones básicas de persistencia.
 *
 * @author Grupo B
 * @version 1.0
 * @since 2025
...
public class ArtistaDAO extends SQLiteDataHelper implements IDAO<ArtistaDTO> {
     ...
     * Inserta los datos del artista en la tabla Artista y asocia sus géneros
     * musicales en la tabla de relación Artista_Genero.
     *
     * @param artista El objeto ArtistaDTO con los datos del artista a registrar
    ...
    /**
     * Recupera todos los artistas registrados en la base de datos.
     * Obtiene la información completa de cada artista incluyendo sus géneros musicales asociados.
     *
     * @return Lista de objetos ArtistaDTO con todos los artistas registrados
    ...
    /**
     * Busca un artista específico por su identificador único.
     * Recupera toda la información del artista incluyendo sus géneros musicales.
     *
     * @param id Identificador único del artista a buscar
     * @return Objeto ArtistaDTO con los datos del artista encontrado, o un objeto vacío si no existe
     * @throws Exception si ocurre un error durante la consulta
     */
    @Override
    ...
    /**
     * Actualiza la información de un artista existente en la base de datos.
     * Modifica los datos del artista y actualiza sus géneros musicales asociados,
     * eliminando las asociaciones anteriores y creando las nuevas.
     *
     * @param artista Objeto ArtistaDTO con los datos actualizados del artista
     ...
     * Realiza una eliminación en cascada, primero removiendo las asociaciones
     * en la tabla Artista_Genero y luego eliminando el registro del artista.
     *
    ...
    /**
     * Método privado auxiliar que recupera los géneros musicales asociados a un artista específico.
     * Consulta la tabla de relación Artista_Genero y convierte los IDs de género
     * en objetos del enum Genero correspondientes.
     *
     * @param idArtista Identificador del artista del cual obtener los géneros
     * @return Lista de géneros musicales asociados al artista
     * @throws Exception si ocurre un error durante la consulta
     */
     ...
     * Útil para determinar si un artista puede ser eliminado sin violar
