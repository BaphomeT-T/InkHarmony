...
| GR1SW                                         |
|-----------------------------------------------|
Autores: Grupo B basado en Grupo A
Descripción: Objeto de transferencia de datos (DAO) que gestiona operaciones CRUD para canciones dentro del sistema InkHarmony.
*/
...
/**
 * Clase de acceso a datos (DAO) para la entidad Cancion.
 * Proporciona operaciones CRUD (Crear, Leer, Actualizar, Eliminar) para gestionar
 * canciones en la base de datos SQLite, incluyendo su metadata, archivos binarios
 * y relaciones con artistas y géneros musicales.
 *
 ...
 * así como sus relaciones con artistas y géneros musicales a través de tablas de unión.</p>
 *
 * @author Grupo B basado en Grupo A
 * @version 1.0
 * @since 2025
 */
public class CancionDAO extends SQLiteDataHelper implements IDAO<CancionDTO> {
     ...
     *
     * @param cancion Objeto CancionDTO que contiene los datos de la canción a registrar
     ...
     * Incluye la metadata completa y las relaciones con artistas y géneros musicales.
     *
     * @return Lista de objetos CancionDTO con todas las canciones registradas
    ...
    /**
     * Busca una canción específica por su identificador único.
     * Recupera toda la información de la canción incluyendo sus relaciones.
     *
     * @param id Identificador único de la canción a buscar
     * @return Objeto CancionDTO completo con todos los datos, o null si no se encuentra
     * @throws Exception si ocurre un error durante la consulta
     */
    @Override
     ...
     * Realiza una búsqueda exacta del título en la base de datos.
     *
     * @param nombre Título exacto de la canción a buscar
     * @return Lista de canciones que coinciden exactamente con el título especificado
     * @throws Exception si ocurre un error durante la consulta
     */
     ...
     * Actualiza los atributos básicos de una canción de forma condicional.
     *
     ...
     *
     * @param entity Objeto {@link CancionDTO} con los nuevos valores a actualizar
    ...
    /**
     * Elimina una canción y todas sus relaciones de la base de datos.
     * Realiza una eliminación en cascada, removiendo primero las asociaciones
     * en las tablas de relación y luego el registro principal de la canción.
     *
    ...
    /**
     * Método privado auxiliar que recupera los artistas asociados a una canción específica.
     * Consulta la tabla de relación Cancion_Artista para obtener los artistas relacionados.
     *
     * @param idCancion Identificador de la canción de la cual obtener los artistas
     * @return Lista de objetos ArtistaDTO relacionados con la canción
    ...
    /**
     * Método privado auxiliar que recupera los géneros musicales asociados a una canción.
     * Consulta la tabla de relación Cancion_Genero y convierte los nombres de género
     * en objetos del enum Genero correspondientes.
     * Se espera que el nombre en la tabla Genero coincida con los valores del Enum Genero.
     *
     * @param idCancion Identificador de la canción de la cual obtener los géneros
     * @return Lista de géneros musicales como enums asociados a la canción
     * @throws Exception si ocurre un error al acceder a la base de datos
     */
    ...
    /**
     * Verifica si existe una canción con el título especificado en estado activo.
     * Útil para validar duplicados antes de registrar nuevas canciones.
     *
     * @param titulo Título de la canción a verificar
     * @return true si existe una canción activa con ese título, false en caso contrario
     */
