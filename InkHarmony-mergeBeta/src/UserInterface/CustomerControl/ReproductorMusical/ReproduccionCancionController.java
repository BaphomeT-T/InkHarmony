...
public class ReproduccionCancionController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        cargarCanciones(); // Puedes mantener esto si no afecta la canción actual
        ...
        reproductor = ReproductorMP3.getInstancia(null);

        if (reproductor != null) {
            byte[] cancionActual = reproductor.getCancionActual();
