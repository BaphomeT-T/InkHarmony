...
public class ReproductorMP3 {
    ...
    /**
     * Devuelve la canción actual que se está reproduciendo.
     *
     * @return Arreglo de bytes correspondiente a la canción actual, o null si no hay playlist.
     */
    public byte[] getCancionActual() {
        return playlist != null ? playlist.obtenerCancionActual() : null;
    }
